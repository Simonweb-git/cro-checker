...
// pretending everything is normal past a threshold no real scan should take. Kept above the platform's
// actual 300s ceiling (api/analysis/route.ts) so a legitimately still-running scan never trips this
// first.
